...
public final class Registro extends javax.swing.JFrame {
    ...
    public JTextField CL;
    public JTextField INSUB;
    public JTextField LPCL;
    public JTextField LPUT;
    public JTextField PAL;
    public JRadioButton SCA;
    public JTextField UT;
    private JButton add;
    private JRadioButton botonFemenino;
    public JRadioButton botonMasculino;
    private JRadioButton botonPrivado;
    public JRadioButton botonPublico;
    private ButtonGroup buttonGroup1;
    private ButtonGroup buttonGroup2;

    public Registro(String id, Busqueda b) {
        initComponents();
        set();
        iniciarRevision();
    ...
    public JRadioButton cca;
    private JButton clear;
    public JComboBox comboNivel;
    ...
    void iniciarRevision() {
        Revisarformato r = new Revisarformato(this);
    ...
    private void textoMouseClicked(MouseEvent evt) {
        mensajeG.setText("");
    }
